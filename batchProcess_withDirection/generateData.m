function [camera, points3D, ptsDirection] = generateData( visualize, totalNumOf3DPoints, noiseLevel,  numOfCameras,numOfImagesPerCam )

% generating 3D points
addpath 'generateSimulatedData\';

% compute the 3d points and the points direction.
[points3D, ptsDirection] = generate3DPoints(totalNumOf3DPoints, noiseLevel, visualize);
