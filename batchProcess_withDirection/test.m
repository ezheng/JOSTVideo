...
% ptsDirection is a 3x3 matrix. each coloumn is one direction.
[camera, points3D, ptsDirection] = generateData(visualize, totalNumOf3DPoints, noiseLevel, numOfCameras,numOfImagesPerCam);
...
%     [camera, newT] = computeT(camera, pred, table);
    [camera,newT] = computeT_direction(camera, pred, table, ptsDirection);
